create table meal(meal_id int(200) primary key, category varchar(100), cuisine varchar(100));
insert into meal(meal_id, category, cuisine) 
values (1885,"Beverages","Thai"),
(1993,"Beverages","Thai"),
(2539,"Beverages","Thai"),
...
select count(category) from meal

#updating the meal
UPDATE meal
SET category='Employee', cuisine='Madhusudhan'
WHERE meal_id=1902;
